...
from backend.api.routes import evidence, entities, graph, bottlenecks, thesis, memo, house_view, regime, claims, models, market, watchlist, digest, analysts
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://localhost:3001",
        "https://*.vercel.app",
        "https://improved-meme-gxq4v9pp49vg3vgv-3000.app.github.dev",
